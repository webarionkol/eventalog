...
export class ProfilePage {
  ...
  ServiceName: any;
  payAmmount: any = "999";
  constructor(public network: Network,public app: App, public alertCtrl: AlertController, public loadingCtrl: LoadingController, public toastCtrl: ToastController, public navCtrl: NavController, private http: HttpClient, public rest: ApiProvider, public navParams: NavParams) {
  ...
  ionViewDidLoad() {
    if (this.network.type != "none") {
      ...
      this.rest.getUserByid(this.userId, this.accessToken).subscribe(res => {
        this.ServiceName=res.productCategory;
        console.log(res)
